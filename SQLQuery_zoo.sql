...
INSERT INTO tbl_care
	...
	('care_4', 'clean up animale waste', '1'),
...
INSERT INTO tbl_habitat
	...
	VALUES
	('tundra',40000),
	('grassy knoll whit trees', 12000),
	('10ft pond and rocks',30000),
	('icy acuarium wiht snowy facade', 50000),
...
SELECT REPLACE(class_type, 'birds', 'bird') FROM tbl_class; --REPLACE() is only temporary. Changing the data that you pull out of the table. not the acctual data in the table.

SELECT UPPER(class_type) FROM tbl_class WHERE class_type = 'bird'; --Returns all upperacse.
SELECT LOWER(class_type) FROM tbl_class WHERE class_type = 'bird'; --Returns all lowercase.
SELECT COUNT(class_type) FROM tbl_class WHERE class_type = 'bird'; --Returns how much results meet the condition.
